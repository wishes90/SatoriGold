...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 830774;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(244000000000000000);
const uint32_t ZAWY_DIFFICULTY_BLOCK_INDEX                   = 18700;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(0); //zero

/* How to generate a premine:

* Compile your code

* Run satwallet, ignore that it can't connect to the daemon, and generate an
...
* Take the hash printed, and replace it with the hash below in 
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010201ff0001b4a8cbdbd80102c18e8e1354936a989133cb426fb019e771d2de67ee8047ec7bdfd18e910b266c21010f1b5b6844138354ba9a982513188ac7b346cbe7aeacf48454c268f4018d865a";
...
const uint32_t FUSION_DUST_THRESHOLD_HEIGHT_V2               = 300000;
...
const uint32_t UPGRADE_HEIGHT_V5                             = 3; // Upgrade height for CN-Turtle Variant 2 switch.
...
const int      SERVICE_DEFAULT_PORT                          =  9075;
